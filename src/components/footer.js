  ...
  <div className='bg-blue-900'>
    <div className='flex justify-around font-montserrat text-white py-3.5 lg:py-11 px-3.5 lg:py-5'>
      <div className='flex'>
        ...
        <div className='flex flex-col self-center font-black'>
          <div className='text-sm md:text-xl lg:text-2xl lg:mb-1'>Philip Kim</div>
          <div className='text-2xs md:text-sm lg:text-base'>Nest Seekers LLC</div>
        </div>
      </div>

      <div className='text-xs md:text-sm lg:text-lg flex-col self-center'>
        <div className='my-1.5'>
          <i className='fa fa-envelope mr-2.5 text-sm lg:text-lg' aria-hidden='true' />
          <a href='mailto:philk@nestseekers.com' target='_blank' rel='noreferrer'>
            philk@nestseekers.com
          </a>
        </div>
        <div className='my-1.5'>
          <i className='fa fa-phone mr-2.5 text-base lg:text-2xl' aria-hidden='true' />
          <a href='tel:917-699-3666'>917.699.3666</a>
        </div>
        <div className='my-1.5'>
          <i className='fa fa-building mr-2.5 text-sm lg:text-xl' aria-hidden='true' />
      ...
      <div className='hidden md:flex flex-col self-center'>
        <a href='https://www.facebook.com/philkrealtor' target='_blank' rel='noreferrer'>
          <img className='w-9' src={facebook_white} alt='Facebook' />
        </a>
      </div>

      <div className='hidden md:flex flex-col text-right'>
        <div className='flex self-end w-14 lg:w-20 h-16 lg:h-20'>
          <svg className='w-full' viewBox='0 0 192.756 192.756'>
        ...
        <div className='flex flex-col text-2xs lg:text-xs'>
          <a
            className='my-px lg:my-1'
          ...
          <a
            className='my-px lg:my-1'
            href='https://www.dos.ny.gov/licensing/docs/2156.pdf'
            target='_blank'
            rel='noreferrer'>
